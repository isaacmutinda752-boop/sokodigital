...
const ProductsAreaAll = () => {
    ...
    const products = [
        ...
        {
            id: 5,
            title: "Complete Flutter for Mobile Apps",
            price: "2,800",
            category: "Courses",
            rating: 4.6,
            sales: 210,
        ...
        {
            id: 6,
            title: "Modern Portfolio Jekyll Template",
            price: "1,500",
            category: "Templates",
            rating: 4.9,
            sales: 67,
        ...
        {
            id: 8,
            title: "Premium Logo Mockup Bundle",
            price: "950",
            category: "Graphics",
            rating: 4.7,
            sales: 432,
    ...
    return (
        <section className="min-h-screen bg-slate-950 py-24 px-6 md:px-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <p className="text-blue-400 font-bold uppercase tracking-widest text-sm">Full Marketplace</p>
                    <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight">
                        All <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Digital Goods</span>
                    </h2>
                    <p className="text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">
                        The ultimate catalog of Kenyan-made software, templates, ebooks and more.
                ...
                >
                    {categories.map((cat) => (
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${selectedCategory === cat
                    ...
                    <AnimatePresence mode="wait">
                        {filteredProducts.length > 0 ? (
                            ...
                            >
                                ...
                                <p className="text-slate-500">We couldn't find any products matching "{searchQuery}" in {selectedCategory}.</p>
                                <button
...
export default ProductsAreaAll;