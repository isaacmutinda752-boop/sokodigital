...
import { FaUser, FaEnvelope, FaPhone, FaArrowRight, FaCircleCheck, FaMoneyBillTrendUp, FaShareNodes } from 'react-icons/fa6';
            ...
            >
                ...
                <div className="space-y-10">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white leading-[1.1]">
                            Earn Money <span className="text-indigo-400">Without</span> a Product.
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed max-w-lg">
                            Join Kenya's fastest-growing digital affiliate network. Share unique links to digital products and earn up to 30% commission on every sale.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        {[
                            { title: "High Commissions", desc: "Earn up to 30% per referral.", icon: <FaMoneyBillTrendUp /> },
                            { title: "M-Pesa Payouts", desc: "Daily payouts for your earnings.", icon: <FaCircleCheck /> },
                            { title: "90-Day Cookies", desc: "Get credit for sales up to 3 months.", icon: <FaShareNodes /> },
                            { title: "Creator Hub", desc: "Access links and assets instantly.", icon: <FaCircleCheck /> }
                        ].map((item, i) => (
                ...
                <div className="bg-slate-900/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-indigo-500/5 relative">
                    <div className="mb-10 text-center lg:text-left">
                        <h3 className="text-2xl font-black text-white">Join as an Affiliate</h3>
                        <p className="text-slate-500 text-sm mt-2">Start your earning journey in under 2 minutes.</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-2">
                            <label className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] ml-1">M-Pesa Number (for Payouts)</label>
                            <div className="relative group">
                        ...
                        <div className="text-center pt-4 border-t border-white/5">
                            <p className="text-slate-500 text-sm">
                                ...
                                <Link to="/AffiliateLoginAccount" className="text-indigo-400 font-bold hover:underline">Login here</Link>
                            </p>
                        </div>
                    </form>
                </div>
