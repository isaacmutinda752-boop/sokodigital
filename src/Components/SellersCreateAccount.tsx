...
import { FaUser, FaStore, FaArrowRight, FaCircleCheck } from 'react-icons/fa6';

const SellersCreateAccount = () => {
    return (
            ...
            >
                ...
                <div className="space-y-10">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white leading-[1.1]">
                            Monetize Your <span className="text-blue-400">Digital Talent.</span>
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed max-w-lg">
                            Kenya's premier platform for digital products. From code to courses,
                            we provide the infrastructure for you to sell and scale instantly.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        {[
                            { title: "Low Fees", desc: "Retain up to 95% of your total earnings." },
                            { title: "M-Pesa Payouts", desc: "Receive funds directly within 24 hours." },
                            { title: "Global Reach", desc: "Your products accessible from anywhere." },
                            { title: "Instant Delivery", desc: "No manual work. We handle fulfillment." }
                        ].map((item, i) => (
                ...
                <div className="bg-slate-900/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-blue-500/5 relative">
                    <div className="mb-10 text-center lg:text-left">
                        <h3 className="text-2xl font-black text-white">Create Seller Account</h3>
                        <p className="text-slate-500 text-sm mt-2">Start your journey in under 2 minutes.</p>
                    </div>

                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        <div className="space-y-2">
                            <label className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] ml-1">Legal Name</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] ml-1">Brand / Shop Name</label>
                            <div className="relative group">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white placeholder:text-slate-600 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all"
                                />
                            </div>
                            <div className="space-y-2">
...
export default SellersCreateAccount